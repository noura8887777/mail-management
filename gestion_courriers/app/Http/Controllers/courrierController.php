...
public function store(Request $request)
{
    ...
    $request->validate([
        ...
        'type_courrier' => 'required|string|in:entrant,sortant', // juste la valeur
    ...
    $courrier = Courrier::create([
        ...
        'type_courrier' => $request->input('type_courrier'), // juste entrant ou sortant
        'statut_id' => $request->input('statut_id'),
        'user_id' => auth()->id() ?? 1, // utilisateur connecté ou 1 par défaut
        'date' => now(),
