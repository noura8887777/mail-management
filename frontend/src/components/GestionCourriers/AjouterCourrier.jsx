...
function AjouterCourrier() {
    ...
    // Types de courrier statiques
    const typesCourrier = [
        { id: 'entrant', nom_type: 'Entrant' },
        { id: 'sortant', nom_type: 'Sortant' }
    ];

    useEffect(() => {
        const fetchStatuts = async () => {
            try {
                const response = await api.get('/courriers/create');
            ...
            <div className="card shadow-sm">
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit} encType="multipart/form-data">
                        ...
                        <div className="row">
                            <div className="col-md-6 mb-3">
                                <label htmlFor="type_courrier" className="form-label fw-bold" style={{ color: '#495057' }}>
                                    Type de courrier
                                </label>
                                <select
                                    name="type_courrier"
