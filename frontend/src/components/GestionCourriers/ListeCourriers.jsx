        ...
        <div className="container mt-3" style={{ backgroundColor: 'white', padding: '20px', borderRadius: '8px' }}>
            ...
            <div className="d-flex justify-content-between align-items-center mb-4 p-3 bg-light rounded">
                ...
                <div>
                    ...
                    <Link to="/ajouter" className="btn btn-danger">
                                    ...
                                    <tr key={cour.id}>
                                        ...
                                        <td>
                                            <div className="d-flex gap-2">
                                                ...
                                                <Link
                                                    to={`/courriers/${cour.id}/edit`}
                                                    className="btn btn-primary btn-sm"
                                                >
                                                    <i className="bi bi-pencil-fill"></i>
                                                </Link>
                                                <Link
                                                    to={`/courriers/${cour.id}`}
                                                    className="btn btn-secondary btn-sm"
                                                >
                                                    <i className="bi bi-eye-fill"></i>
                                                </Link>
                                                {cour.type_courrier_id === 2 && (
                                                    <Link
                                                        to={`/affectations/${cour.id}`}
                                ...
                                {courriersReponse.map(cour => (
                                    <tr key={cour.id}>
                                        ...
                                        <td>
                                            <div className="d-flex gap-2">
                                            <Link
                                                    to={`/reponse/${cour.id}/edit`}
                                                    className="btn btn-primary btn-sm"
                                                >
                                                    <i className="bi bi-pencil-fill"> modifier reponse</i>
                                                </Link>
                                            </div>
                                        </td>
                                    </tr>
